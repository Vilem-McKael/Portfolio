...
export default function SideBar({currentPageName}) {
  ...
  return (
    ...
    <div className='flex flex-col items-start justify-evenly fixed left-0 top-[5vh] bottom-[5vh] max-w-[14vw] h-[90vh] p-[2vmin] bg-accent2 border-[.3vmin] border-l-0 border-light2 rounded-r-[20px]'>
        
            <div onMouseEnter={() => handleHover('welcome')} onMouseLeave={() => clearHovers()} className='flex flex-row items-center border-light2 border-b-[.3vmin]'>
            ...
            <div onMouseEnter={() => handleHover('about')} onMouseLeave={() => clearHovers()} className='flex flex-row items-center mt-[1vmin] border-light2 border-b-[.3vmin]'>
            ...
            <div onMouseEnter={() => handleHover('projects')} onMouseLeave={() => clearHovers()} className='flex flex-row items-center mt-[1vmin] border-light2 border-b-[.3vmin]'>
            ...
            <div onMouseEnter={() => handleHover('contact')} onMouseLeave={() => clearHovers()} className='flex flex-row items-center mt-[1vmin]'>
