  ...
  return (
    <div className='flex flex-col'>
        <div className='flex items-center justify-center mb-[2vh] bg-light1 border-[5px] border-dark rounded-[50%] transition hover:scale-110'>
            <Link onClick={() => window.open('https://www.linkedin.com/in/vilem-mckael')}><img src={linkedInLogo} className='h-[50px] rounded-[50%] my-[1px] shadow-lg shadow-blue-800'/></Link>
        </div>
