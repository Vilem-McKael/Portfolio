  ...
  return (
    <div className='flex flex-col'>
        ...
        <div className='flex items-center justify-center bg-light2 border-[3px] border-accent2 rounded-[50%]'>
            <Link onClick={() => window.open('https://www.github.com/vilem-mckael')} className='flex items-center justify-center'><img src={githubLogo}className='h-[3.5vh] rounded-[50%]'/></Link>
        </div>
    </div>
  )
}
