...
export default function ProjectCard({link, title, demoGIF, description}) {
  return (
    ...
    <div className='flex flex-col w-[24vw] max-w-[360px] min-w-[300px] h-[22vh] max-h-[300px] min-h-[250px] p-2 justify-center items-center bg-[#88cc88] border-black border-[.2vmin] box-border rounded-[10px]'>
