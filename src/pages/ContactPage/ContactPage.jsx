...
export default function ContactPage({updatePageName}) {
  ...
  return (
    ...
    <div className='flex flex-col justify-center items-center h-[90vh] w-[100vw] max-w-[1200px] bg-gradient-to-br from-dark to-accent2 text-light2 text-center'>
      <div className='mt-[80px] mb-[20px] md:mb-[4vh] bg-light1 border-light border-[.3vmin] rounded-[8px] md:rounded-[10px]'>
      ...
      <div className='flex flex-row justify-evenly w-[80vw] max-w-[1000px] flex-wrap'>
        <Link onClick={() => window.open('https://www.github.com/vilem-mckael')} className='flex flex-col justify-center items-center'>
        <div className='flex flex-col justify-center items-center w-[70px] h-[70px] md:w-[140px] md:h-[140px] p-[10pxvmin] rounded-[15%] bg-accent2'>
          <img src={githubLogo} className='md:max-w-[120px] md:max-h-[120px] bg-light2 rounded-[12%]'/>
          
        </div>
        <div className='text-[10px] md:text-[20px] text-light2 mt-[20px] w-[150px] md:w-[300px]'>
            Visit my GitHub profile
          </div>
        </Link>
        <Link onClick={() => window.open('https://www.linkedin.com/in/vilem-mckael')} className='flex flex-col justify-center items-center'>
        <div className='flex flex-col justify-center items-center w-[70px] h-[70px] md:w-[140px] md:h-[140px] p-[10px] rounded-[15%] bg-accent2'>
      ...
      {!submitted ?
        <div className='flex flex-col justify-center items-center w-full md:w-[40vw] mb-[20px] h-[60vh]'>
          <div className='text-[10px] md:text-[16px] mb-[2vh]'>
            Feel welcome to leave a message for me down below,<br />
            and I will get back to you as soon as possible
          </div>
          <div className='flex flex-col md:flex-row w-[60vw] max-w-[1000px] justify-between mb-[2vh]'>
            <div>
          ...
          <textarea className=' p-2 bg-light1 w-[60vw] max-w-[1000px] h-[20vh] text-dark placeholder-gray-500 text-[10px] md:text-[1.5vmin]' name='message' value={formData.message} placeholder='Your Message' maxLength='1500' onChange={handleChange}>
            
          </textarea>
          <div className='flex flex-row justify-center md:justify-end w-[60vw] max-w-[1000px]'>
            <button type='submit' onClick={handleSubmit} className='mt-[2vh] p-2 w-full md:w-auto bg-[#aaeeaa] text-dark rounded-[5px] '>
              Submit
            </button>
          </div>
        </div>
