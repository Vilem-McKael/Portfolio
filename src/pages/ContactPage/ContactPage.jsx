  ...
  return (
    <div className='flex flex-col justify-center items-center h-[90vh] w-[100vw] max-w-[1200px] bg-gradient-to-br from-dark to-med_dark text-light2 text-center'>
      <div className='mt-[8vh] mb-[4vh] bg-light1 border-light border-[.3vmin] rounded-[10px]'>
          <h1 className='text-[48px] text-dark py-[1vh] px-[2vh] border-black border-[.1vmin] font-bold rounded-[6px]'>
          Contact Me
          </h1>
        </div>
      <div className='flex flex-row justify-evenly w-[80vw] flex-wrap'>
        ...
        <div className='text-[20px] text-light2 mt-[2vh] w-[30vmin]'>
        ...
        <div className='text-[20px] text-light2 mt-[2vh] w-[20vmin]'>
